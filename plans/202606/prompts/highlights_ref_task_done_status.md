...
ref note is `done` (e.g. the article/paper/book has been read)? Think this through thoroughly and create a plan using your `/sase_plan` skill. Submit your plan with the `sase plan`
