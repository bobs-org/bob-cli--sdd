...
a new `type` frontmatter property. Make sure to updare all existing ~/bob/done/ files accordingly! Think this through thoroughly and create a plan using your `/sase_plan` skill. Submit your plan with the `sase plan`
